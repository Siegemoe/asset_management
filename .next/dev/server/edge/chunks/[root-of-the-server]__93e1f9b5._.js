(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__93e1f9b5._.js",
...
const envSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    DATABASE_URL: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "Database URL is required"),
    DIRECT_URL: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    GOOGLE_CLIENT_ID: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "Google Client ID is required"),
    GOOGLE_CLIENT_SECRET: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "Google Client Secret is required"),
    NEXTAUTH_URL: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().url().optional().default("http://localhost:3000"),
    NEXTAUTH_SECRET: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(32, "NextAuth secret must be at least 32 characters"),
...
function createPrismaClient() {
    const prisma = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prisma$2f$client$2f$edge$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["PrismaClient"]({
        datasources: {
            db: {
                url: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["dbConfig"].url
            }
        }
...
if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["isDevelopment"]) globalForPrisma.prisma = prisma;
}),
...
"[project]/src/lib/security/sessionStore.ts [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class SessionStore {
   ...
   */ static async createSession(userId, sessionToken, refreshToken, deviceInfo, ipAddress, userAgent) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["prisma"].userSession.create({
            data: {
                id: sessionData.id,
   ...
   */ static async getSession(sessionToken) {
        try {
            const session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["prisma"].userSession.findUnique({
                where: {
                    sessionToken
                }
            });
            ...
            if (session.expiresAt < new Date()) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["prisma"].userSession.update({
                    where: {
                        id: session.id
                    },
                    data: {
   ...
   */ static async invalidateSession(sessionToken) {
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["prisma"].userSession.updateMany({
                where: {
                    sessionToken
                },
                data: {
   ...
   */ static async getUserSessions(userId) {
        try {
            const sessions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["prisma"].userSession.findMany({
                where: {
                    userId,
                    status: 'ACTIVE'
                },
   ...
   */ static async cleanupExpiredSessions() {
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["prisma"].userSession.deleteMany({
                where: {
                    OR: [
                        {
                            expiresAt: {
   ...
   */ static async getSessionStats() {
        try {
            ...
            const [totalSessions, activeSessions, expiredSessions] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["prisma"].userSession.count(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["prisma"].userSession.count({
                    where: {
                        status: 'ACTIVE',
                        expiresAt: {
            ...
            const activeSessionsData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["prisma"].userSession.findMany({
                where: {
                    status: 'ACTIVE'
                },
                select: {
            ...
            const averageSessionDuration = activeSessionsData.length > 0 ? activeSessionsData.reduce((sum, session)=>{
                return sum + (now.getTime() - session.createdAt.getTime());
            }, 0) / activeSessionsData.length : 0;
            return {
                totalSessions: totalSessions,
                activeSessions,
                expiredSessions,
                averageSessionDuration: Math.round(averageSessionDuration / 1000 / 60)
            };
        } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$simpleAuditLogger$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/security/simpleAuditLogger.ts [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$sessionStore$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/security/sessionStore.ts [middleware-edge] (ecmascript)");
;
;
class SessionManager {
   ...
   */ static async createSession(userId, sessionToken, refreshToken, deviceInfo, ipAddress, userAgent) {
        ...
        const sessionInfo = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$sessionStore$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SessionStore"].createSession(userId, sessionToken, refreshToken, deviceInfo, ipAddress, userAgent);
   ...
   */ static async validateSession(sessionToken, ipAddress, userAgent) {
        // Use SessionStore to validate session
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$sessionStore$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SessionStore"].validateSession(sessionToken, ipAddress, userAgent);
    }
    /**
   ...
   */ static async invalidateSession(sessionToken, userId, reason = 'manual_invalidation', ipAddress, userAgent) {
        // Use SessionStore to invalidate session
        const success = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$sessionStore$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SessionStore"].invalidateSession(sessionToken);
        if (success) {
   ...
   */ static async invalidateAllUserSessions(userId, reason = 'security_reason', ipAddress, userAgent) {
        // Use SessionStore to invalidate all user sessions
        const invalidatedCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$sessionStore$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SessionStore"].invalidateAllUserSessions(userId);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$simpleAuditLogger$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SimpleAuditLogger"].logSecurityEvent('PASSWORD_CHANGE', userId, {
   ...
   * Get all active sessions for a user
   */ static async getUserSessions(userId) {
        // Use SessionStore to get user sessions
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$sessionStore$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SessionStore"].getUserSessions(userId);
    }
    /**
   * Clean up expired sessions
   */ static async cleanupExpiredSessions() {
        // Use SessionStore to clean up expired sessions
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$sessionStore$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SessionStore"].cleanupExpiredSessions();
    }
    /**
   ...
   */ static async checkSuspiciousActivity(userId, currentIpAddress, currentUserAgent) {
        ...
        try {
            const sessions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$sessionStore$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SessionStore"].getUserSessions(userId);
   ...
   * Get session statistics
   */ static async getSessionStats() {
        // Use SessionStore to get session statistics
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2f$sessionStore$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SessionStore"].getSessionStats();
    }
    /**
...
const { handlers, auth, signIn, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])({
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$node_modules$2f40$auth$2f$core$2f$providers$2f$google$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"])({
            clientId: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["authConfig"].googleClientId,
            clientSecret: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["authConfig"].googleClientSecret
        }),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__93e1f9b5._.js.map